...
public class ReportService {
    ...
    public  IncomeDTO incomeReport(Integer idAdmina){
        System.out.println("Uslo u incomeReport ");
        double first=0;
        double second=0;
        double third=0;
        PharmacyAdmin pharmacyAdmin=pharmacyAdminRepository.findOneById(idAdmina);
        List<Examination>examinations=examinationRepository.findExaminationsByIdPharm(pharmacyAdmin.getPharmacy().getIdPharm());
        for (Examination e:examinations){
            System.out.println(" Ime "+e.getPrice());
            if(e.getDate().getMonthValue()==1){
                first+=e.getPrice();
            }
            if(e.getDate().getMonthValue()==2){
                second+=e.getPrice();
            }
            if (e.getDate().getMonthValue()==3){
                third+=e.getPrice();
            }
        }
        return new IncomeDTO(first,second,third);
    }
    ...
    public DaysDTO monthlyReportForDrugsDays(Integer idAdmina,Integer month,Integer year){
        PharmacyAdmin pharmacyAdmin=pharmacyAdminRepository.findOneById(idAdmina);
        List<DrugReservation>drugReservationList=drugReservationRepository.findAllByPharmacy(pharmacyAdmin.getPharmacy());
        ...
        DaysDTO daysDTO=new DaysDTO(numberOfExaminationForDay1,numberOfExaminationForDay2,numberOfExaminationForDay3,numberOfExaminationForDay4,numberOfExaminationForDay5,numberOfExaminationForDay6
        ,numberOfExaminationForDay7,numberOfExaminationForDay8,numberOfExaminationForDay9,numberOfExaminationForDay10,numberOfExaminationForDay11,numberOfExaminationForDay12,numberOfExaminationForDay13,numberOfExaminationForDay14,numberOfExaminationForDay15,numberOfExaminationForDay16,numberOfExaminationForDay17,numberOfExaminationForDay18,numberOfExaminationForDay19,numberOfExaminationForDay20,numberOfExaminationForDay21,numberOfExaminationForDay22,numberOfExaminationForDay23,numberOfExaminationForDay24,numberOfExaminationForDay5,numberOfExaminationForDay26,numberOfExaminationForDay27,numberOfExaminationForDay28,numberOfExaminationForDay29,numberOfExaminationForDay30,numberOfExaminationForDay31);
    ...
    public DaysDTO monthlyReportDay(Integer idAdmina, Integer month){
